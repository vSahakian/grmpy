...
basic_df_array = np.c_[robj.evnum,robj.sta,robj.E_residual,robj.site_terms,robj.path_terms,robj.site_stderr]
basic_df = pd.DataFrame(basic_df_array,columns=['evnum','sta','E_residual','site_terms','path_terms','site_stderr'])
