...
home=HOME+'/anza'
invrun='v6anza2013_pga_noVs30_5coeff'
...
#Filename:
dbpath=home+'/data/databases/v6anza2013/v6anza2013_pgrid_5sta.pckl'
...
run_name = 'mixedregr_v6anza2013_pga_%icoeff_Mc_8.5_noVs30' % ncoeff
...
# Read in model so you don't have to run the entire thing:
fixedmodel = '/Users/vsahakian/anza/models/pckl/v6anza2013_pga_noVs30_5coeff/regr_pga_Mc8.5_0.0_6.5_VR_98.8.pckl'
...
print 'Running mixed effects'
#Now try with mixed effects:
run_name = 'mixedregr_v6anza2013_pga_%icoeff_%s_Mc_8.5_noVs30' % (ncoeff,fixedcoeff_list)
run_home=home+'/models/residuals/'
resaxlim_r = [[0,290],[-6,7.5]]
resaxlim_mw = [[0,4.5],[-6,7.5]]

# INversion run  name - called "dbname" here - setting a4 through a6:
dbname = 'v6anza2013_pga_noVs30_5coeff_a4_-1.2'
