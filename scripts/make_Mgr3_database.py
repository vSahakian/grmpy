...
# Final database name:
dbname = 'v1Mgr3_pgrid_5sta'

#Janine's flatfile:
flatfile_pga=HOME+'/anza/data/databases/mwgreater3/PGA_anzaM3all.dat'
...
vs30_sta_file = HOME + '/anza/data/vs30/stations_v1Mgr3.txt'

# Vs30 proxy ID file, from R:
vs30_proxyIDfile = HOME +'/anza/data/vs30/v1Mgr3_IDproxyVs30.txt'

# Vs30 conversion file:
vs30_conversionfile = HOME + '/anza/data/vs30/y16_terrain2vs30.txt'

# Vs30 proxy file, after converting ID:
vs30_proxyfile = HOME +'/anza/data/vs30/v1Mgr3_proxyVs30.txt'

# Alan's vs30 csv file:
measured_vs30_csvfile = HOME + '/anza/data/vs30/yong_measuredVs30.csv'

# Output Vs30 file with measured vs30:
vs30_measuredfile = HOME + '/anza/data/vs30/v1Mgr3_measuredVs30.txt'

#Output Vs30 file:
vs30name='v1Mgr3_vs30.txt'
vs30_outfile=HOME+'/anza/data/vs30/'+vs30name
######################


#Save the database object paths:
dbfname_raw=HOME+'/anza/data/databases/mwgreater3/v1Mgr3.pckl'
dbfname_pgrid=HOME+'/anza/data/databases/mwgreater3/v1Mgr3_pgrid.pckl'
dbfname=HOME+'/anza/data/databases/mwgreater3/v1Mgr3_pgrid_5sta.pckl'

#Figure paths:
fig_dir=HOME+'/anza/data/databases/mwgreater3/figs/'
...
#Read in the data:
evnum,evlat,evlon,evdep,sta,stlat,stlon,stelv,grcircle,ml,mw,pga_millig,source_i,receiver_i=dr.read_jsbfile(flatfile_pga)
