...
# Final database name:
dbname = 'v4anza2013_pgrid_5sta'

#Janine's flatfile:
flatfile=HOME+'/anza/data/databases/v4anza2013/test.dat'
...
vs30_sta_file = HOME + '/anza/data/vs30/stations_v3anza2013.txt'

# Vs30 proxy ID file, from R:
vs30_proxyIDfile = HOME +'/anza/data/vs30/v2anza2013_IDproxyVs30.txt'

# Vs30 conversion file:
vs30_conversionfile = HOME + '/anza/data/vs30/y16_terrain2vs30.txt'

# Vs30 proxy file, after converting ID:
vs30_proxyfile = HOME +'/anza/data/vs30/v3anza2013_proxyVs30.txt'

# Alan's vs30 csv file:
measured_vs30_csvfile = HOME + '/anza/data/vs30/yong_measuredVs30.csv'

# Output Vs30 file with measured vs30:
vs30_measuredfile = HOME + '/anza/data/vs30/v3anza2013_measuredVs30.txt'

#Output Vs30 file:
vs30name='v3anza2013_vs30.txt'
vs30_outfile=HOME+'/anza/data/vs30/'+vs30name
######################


#Save the database object paths:
dbfname_raw=HOME+'/anza/data/databases/v3anza2013/v3anza2013.pckl'
dbfname_pgrid=HOME+'/anza/data/databases/v3anza2013/v3anza2013_pgrid.pckl'
dbfname=HOME+'/anza/data/databases/v3anza2013/v3anza2013_pgrid_5sta.pckl'

#Figure paths:
fig_dir=HOME+'/anza/data/databases/v3anza2013/figs/'
