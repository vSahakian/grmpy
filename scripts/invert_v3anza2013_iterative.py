...
#print 'Running mixed effects'
##Now try with mixed effects:
#run_name = 'mixedregr_v2anza2013_pga_%icoeff_%s_Mc_8.5_res4' % (ncoeff,fixedcoeff_list)
#run_home=home+'/models/residuals/'
#resaxlim_r = [[0,180],[-5,5]]
#resaxlim_mw = [[0,4],[-5,5]]
#
...
#    
####################################################################################
###########      MIXED EFFECTS with fixed coeffs, invert a1 & a2    ################
####################################################################################
##
#
## Read in model so you don't have to run the entire thing:
#fixedmodel = '/Users/vsahakian/anza/models/pckl/v2anza2013_pga_vs30_6coeff/regr_pga_Mc8.5_0.0_6.5_VR_99.4.pckl'
#
